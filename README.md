...
| Module | Completed |
|--------|-----------|
| Implement a responsible generative AI solution in Microsoft Foundry | Jul 2026 |
| Optimize generative AI model performance with Microsoft Foundry | Jul 2026 |
| Develop generative AI apps that use tools | Jul 2026 |
| Develop a generative AI chat app with Microsoft Foundry | Jul 2026 |
| Select, deploy, and evaluate Microsoft Foundry models | Jul 2026 |
| Get started with AI-powered information extraction in Azure | Jul 2026 |
| Generate images with AI | Jul 2026 |
| Plan and prepare to develop AI solutions on Azure | Jul 2026 |
| Create a knowledge mining solution with Azure AI Search | Jul 2026 |
| Develop a vision-enabled generative AI application | Jul 2026 |
| Get started with AI in Azure | Jul 2026 |
| Write your first C# code | Apr 2025 |
| Store and retrieve data using literal and variable values in C# | Apr 2025 |
